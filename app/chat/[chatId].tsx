...
export default function ChatScreen() {
  ...
  async function handleSend() {
    if (!message.trim() || !chatId || !chat) return;
    ...
    try {
      ...
      setMessage("");
      Keyboard.dismiss();
      await loadChat(); // Reload to get the new message
    } catch (err) {
    ...
    <SafeAreaView style={s.root} edges={["top", "bottom"]}>
      ...
      >
        ...
        <View style={s.inputContainer}>
          ...
          >
            {isSending ? <ActivityIndicator size="small" color="#fff" /> : <SendIcon />}
          </TouchableOpacity>
        </View>
      </KeyboardAvoidingView>
    </SafeAreaView>
...
const s = StyleSheet.create({
  ...
  sendBtn: { 
    ...
    alignItems: "center", justifyContent: "center", marginLeft: 12, marginBottom: 0
  },
